...
const ChatBot = () => {
  ...
  const questions = [
    ...
    {
      id: "siteName",
      text: "What do you want the name of your site/app to be?",
    },
    { id: "siteType", text: "What type of website or app do you want?" },
    { id: "budget", text: "What is your budget?" },
    {
      id: "siteStyle",
      text: "What colors, style, and functionality do you want the site to have?",
    },
    { id: "deadline", text: "When do you want it to be ready?" },
    {
      id: "additionalInfo",
      text: "Anything else you want me to know about your site?",
    },
  ];
